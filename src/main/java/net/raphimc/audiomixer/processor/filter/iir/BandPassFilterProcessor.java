...
public class BandPassFilterProcessor extends BiquadFilterProcessor<BandPassFilterProcessor.InternalProcessor> {
    ...
    public BandPassFilterProcessor(final float frequency) {
        this.frequency.set(frequency);
    }

    public BandPassFilterProcessor(final float frequency, final float q) {
        this.frequency.set(frequency);
        this.q.set(q);
    }
