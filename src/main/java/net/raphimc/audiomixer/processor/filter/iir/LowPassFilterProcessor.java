...
public class LowPassFilterProcessor extends BiquadFilterProcessor<LowPassFilterProcessor.InternalProcessor> {
    ...
    public LowPassFilterProcessor(final float frequency) {
        this.frequency.set(frequency);
    }

    public LowPassFilterProcessor(final float frequency, final float q) {
        this.frequency.set(frequency);
        this.q.set(q);
    }
