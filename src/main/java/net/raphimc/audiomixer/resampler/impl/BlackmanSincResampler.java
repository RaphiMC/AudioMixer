...
public final class BlackmanSincResampler extends SincResampler {
    ...
    @Override
    protected double evaluateWindow(final double normalizedDistance) {
        return MathUtil.multiplyAndAdd(0.08D, MathUtil.cos(MathUtil.TWO_PI * normalizedDistance), MathUtil.multiplyAndAdd(0.5D, MathUtil.cos(Math.PI * normalizedDistance), 0.42D));
    }
